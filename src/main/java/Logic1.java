...
public class Logic1
{
    ...
    public boolean less20(int n) {
      boolean one = (n+1)%20 == 0;
      boolean two = (n+2)%20 == 0;
      if(one||two){
          return true;
      }else{
          return false;
    ...
    public boolean nearTen(int num) {
      boolean oneDown = (num-1)%10 == 0;
      boolean twoDown = (num-2)%10 == 0;
      boolean oneUp = (num+1)%10 == 0;
      boolean twoUp = (num+2)%10 == 0;
      if((num%10) == 0){
          return true;
      }else{
          if(oneDown || twoDown || oneUp || twoUp){
              return true;
          }else{
              return false;
          }
    ...
    public boolean lastDigit(int a, int b, int c) {
      ...
      int bLast = b%10;
      int cLast = c%10;
      boolean a2C = aLast == cLast;
      boolean b2C = bLast == cLast;
      boolean a2B = aLast == bLast;
      if(a2C || b2C || a2B){
          return true;
      }else{
          return false;
    ...
    public int teaParty(int tea, int candy) {
        boolean greatCon = (tea*2)<=candy || (candy*2)<=tea;
        if(tea<5 || candy<5){
            return 0;
        }else{
            if(greatCon){
    ...
    public boolean squirrelPlay(int temp, boolean isSummer) {
        boolean inRange = temp>=60 && temp<=90;
        boolean inRangeSummer = temp>=60 && temp<=100;
        if(isSummer){
            if(inRangeSummer){
                return true;
            }else{
